import { getValueByPath, promiseObject, removeElement, merge } from './helpers.mjs';
...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":_vm.animation}},[_c('article',{directives:[{name:"show",rawName:"v-show",value:(_vm.isActive),expression:"isActive"}],class:_vm.rootClasses},[(_vm.closable)?_c('button',{class:_vm.closeClasses,attrs:{"type":"button","aria-label":_vm.ariaCloseLabel},on:{"click":function($event){return _vm.close({action: 'close', method: 'x'})}}},[_c('o-icon',{attrs:{"clickable":"","pack":_vm.iconPack,"both":"","icon":_vm.closeIcon,"size":_vm.closeIconSize}})],1):_vm._e(),(_vm.component)?_c(_vm.component,_vm._g(_vm._b({tag:"component",on:{"close":_vm.close}},'component',_vm.props,false),_vm.events)):_vm._e(),(_vm.$scopedSlots.default || _vm.message)?_c('div',{class:_vm.wrapperClasses},[(_vm.computedIcon)?_c('o-icon',{class:_vm.iconClasses,attrs:{"icon":_vm.computedIcon,"pack":_vm.iconPack,"both":"","size":_vm.iconSize,"aria-hidden":""}}):_vm._e(),_c('div',{class:_vm.contentClasses},[(_vm.$scopedSlots.default)?[_vm._t("default",null,{"closeNotification":_vm.close})]:[_c('span',{domProps:{"innerHTML":_vm._s(_vm.message)}})]],2)],1):_vm._e()],1)])};
