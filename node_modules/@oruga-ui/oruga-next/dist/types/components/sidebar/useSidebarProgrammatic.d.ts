...
export type SidebarProgrammaticOptions<C extends Component> = Readonly<SidebarProps<C>> & ProgrammaticComponentOptions;
declare const SidebarProgrammatic: {
     ...
     */
    open<C extends Component>(options: SidebarProgrammaticOptions<C>, target?: MaybeRefOrGetter<string | HTMLElement | null>): ProgrammaticExpose;
