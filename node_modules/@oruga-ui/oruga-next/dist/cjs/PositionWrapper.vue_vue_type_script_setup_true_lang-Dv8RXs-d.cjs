...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function addHandler() {
      if (config.isClient && !scrollingParent.value && contentRef.value) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.Teleport, {
        ...
        _teleport.value.disabled ? vue.renderSlot(_ctx.$slots, "default", {
          key: 0,
          setContent
...
//# sourceMappingURL=PositionWrapper.vue_vue_type_script_setup_true_lang-Dv8RXs-d.cjs.map
